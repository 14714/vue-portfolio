    ...
    <div class="container mt-16 flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full">
        <div class="flex flex-wrap md:flex-nowrap">
            <div class="flex flex-wrap lg:ml-20 justify-center md:justify-start max-w-xl mt-0 md:my-36">
                <h1 class="font-regular text-[#0EE6B7] text-5xl md:text-6xl lg:text-7xl text-center md:text-left">¡Hi!</h1>
                <h1 class="font-bold text-5xl md:text-6xl lg:text-7xl text-center md:text-left">I'm Matias Castillo</h1>
                <h1 class="font-bold text-transparent text-stroke text-5xl md:text-6xl lg:text-7xl text-center md:text-left">fullstack developer</h1>
        ...
        <div class="flex flex-wrap md:flex-nowrap">
            <img src="../assets/Recurso2.png" alt="">
        </div>
	</div>
</template>
...
.text-stroke{
    ...
    -webkit-text-stroke-color: #0ee6b7;
}
</style>